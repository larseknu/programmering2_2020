...
public class DyreRepository {

    private Connection connection;
    private DateTimeFormatter fodselsDatoFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd hh:mm:ss");
    ...
    public Dyr hentDyrMedId(int id) {
             ...
             ResultSet resultSet = stmnt.executeQuery("SELECT * FROM dyr WHERE id = " + id + ";"))
        {
            if (resultSet.next()) {
                ...
                LocalDate fodselsdato = LocalDate.parse(fodselsDatoString, fodselsDatoFormatter);
             ...
             ResultSet resultSet = statement.executeQuery("SELECT * FROM dyr;"))
        {
            ...
            while (resultSet.next()) {
                dyreListe.add(new Dyr(resultSet.getInt("id"),
                        ...
                        LocalDate.parse(resultSet.getString("fodselsdato"), fodselsDatoFormatter)));
            }
        }
        catch(SQLException sqle)
        {
