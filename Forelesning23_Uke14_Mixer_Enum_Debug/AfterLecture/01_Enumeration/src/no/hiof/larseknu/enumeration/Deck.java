...
public class Deck {
    ...
    public Deck() {
        for (Card.Suit kortType : Card.Suit.values()) {
            for (CardValue kortVerdi : CardValue.values()) {
                cards.add(new Card(kortType, kortVerdi));
            }
        }
    ...
    public Stack<Card> getDeckOfCards() { return cardStack; }
