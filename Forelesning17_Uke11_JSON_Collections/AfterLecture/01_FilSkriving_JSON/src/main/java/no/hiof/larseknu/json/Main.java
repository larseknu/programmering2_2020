...
import no.hiof.larseknu.json.model.Barbar;
import no.hiof.larseknu.json.model.Karakter;
import no.hiof.larseknu.json.model.Klasse;
import no.hiof.larseknu.json.model.Trollmann;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Trollmann trollmann = new Trollmann("Trollmann", "En magi bruker", 6);
        trollmann.leggTilTrylleformel("Flammeball");
        trollmann.leggTilTrylleformel("Taskenspilleri");

        Barbar barbar = new Barbar("Barbar", "En sterk fyr", 12, 3);
